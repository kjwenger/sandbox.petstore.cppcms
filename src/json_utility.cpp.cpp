...
namespace sandbox_cppcms {
    ...
    cppcms::json::value & json_utility::copy(const sandbox_cppcms::model::pet & pet, cppcms::json::value & value) {
        value["id"] = pet.id;
        value["name"] = pet.name;
        int index = 0;
        for (auto
    ...
    sandbox_cppcms::model::pet & json_utility::copy(const cppcms::json::value & value, sandbox_cppcms::model::pet & pet) {
